...
using GutoShopping.CartAPI.Migrations;
...
namespace GutoShopping.CartAPI.Repository
{
    public class CartRepository : ICartRepository
    {
        ...
        public CartRepository(ProductContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        public async Task<CartVO> SaveOrUpdateCart(CartVO vo)
        {
            ...
            {
                var cartDetail = await _context.CartDetails.AsNoTracking().FirstOrDefaultAsync(p => p.ProductId == cart.CartDetails.FirstOrDefault()
